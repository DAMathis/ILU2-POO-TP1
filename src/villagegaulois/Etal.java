	...
	public String acheterProduit(int quantiteAcheter, Gaulois acheteur) throws IllegalArgumentException, IllegalStateException {
		...
		if (!etalOccupe) {
			throw new IllegalStateException(
				"Cannot invoke \"villagegaulois.Etal.acheterProduit()\" because \"Etal.isEtalOccupe()\" is false");
		}
		if (quantiteAcheter < 1) {
			throw new IllegalArgumentException(
				"Cannot invoke \"villagegaulois.Etal.acheterProduit()\" because \"quantiteAcheter\" lower than zero");
		}
